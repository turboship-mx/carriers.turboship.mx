...
- Mantener historial de decisiones visibles en un solo lugar.

## Formato sugerido

En cada entrega vas a ver:

1. Que cambio.
2. A quien impacta.
3. Si requiere accion.
4. Fecha estimada o fecha de salida.

## Nota

Este contenido es un placeholder inicial para dejar la estructura lista.
